...
public interface IRepository<T> where T : class
{
    ...
    /// <returns>A task representing the asynchronous operation. The result of the task is a boolean indicating if any entity exists.</returns>
    ...
    /// <param name="cancellationToken">A token for cancelling the asynchronous operation.</param>
    /// <returns>A task representing the asynchronous operation. The result of the task is a boolean indicating if any entity matching the criteria exists.</returns>
    ...
    /// </summary>
    /// <param name="cancellationToken">A token for cancelling the asynchronous operation.</param>
    /// <returns>A task representing the asynchronous operation. The result of the task is the first entity in the repository, or <see langword="null"/> if the repository is empty.</returns>
    ...
    /// <param name="filterCriteria">The filter criteria.</param>
    /// <param name="cancellationToken">A token for cancelling the asynchronous operation.</param>
    /// <returns>A task representing the asynchronous operation. The result of the task is the first entity that satisfies the filter criteria, or <see langword="null"/> if no entity is found.</returns>
    ...
    /// <param name="filterCriteria">The filter criteria.</param>
    /// <param name="cancellationToken">A token for cancelling the asynchronous operation.</param>
    /// <returns>A task representing the asynchronous operation. The result of the task is the single entity that satisfies the filter criteria, or <see langword="null"/> if no entity is found.</returns>
